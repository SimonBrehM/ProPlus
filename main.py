...
def anal_subjects(sbj_list:list):
    ...
    sbj_dico = {
        ...
        "CDM > CDM" : ["CDM","static/img/icons/w_CDM_final.png","static/img/icons/d_CDM_final.png"],
        ...
        "ENSEIGN.SCIENTIFIQUE > PH-CH" : ["ES PC","static/img/icons/w_p-c_final.png","static/img/icons/d_p-c_final.png"],
        ...
        "ESPAGNOL LV2" : ["ESPAGNOL LV2","static/img/icons/w_LV2_esp_final.png","static/img/icons/d_LV2_esp_final.png"],
