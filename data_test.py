...
sample_client = Client([
    Trimester("T1", [
        Grade(Subject("Maths"), str(random.randint(5, 20)), "20", False, False, str(random.randint(1, 6)), "grade1", str(random.randint(5, 20))),
        Grade(Subject("Physique"), str(random.randint(5, 20)), "20", False, False, str(random.randint(1, 6)), "grade2", str(random.randint(5, 20))),
        Grade(Subject("Francais"), str(random.randint(5, 20)), "20", False, False, str(random.randint(1, 6)), "grade3", str(random.randint(5, 20))),
        Grade(Subject("SCIENCES VIE & TERRE"), str(random.randint(5, 20)), "20", False, False, str(random.randint(1, 6)), "grade4", str(random.randint(5, 20))),
